...
os.environ["CUDA_VISIBLE_DEVICES"] = "7"  # 只让程序看到第2张卡
device = "cuda" if torch.cuda.is_available() else "cpu"
DATA_ROOT = "./datasets/datasets/svhn"
...
TEMPLATES = [
    ...
    "a sign showing the digit {}."
]

# ===============================
# Dataset for SVHN (你的格式)
# ===============================
class SVHNTxtDataset(Dataset):
...
if __name__ == "__main__":
    # 选择你想评估的 split
    SPLIT_TXT = "test.txt"  # 也可改为 train800.txt / val200.txt / train800val200.txt
    ...
    df.to_csv("svhn_zero_shot_results.csv", index=False)
    print("\n📊 Done! Results saved to svhn_zero_shot_results.csv")
