...
# 数据路径================================
DATA_ROOT = "./datasets/datasets/diabetic_retinopathy"
...
# 文本模板================================
TEMPLATES = [
    "a retinal fundus photograph showing {}.",
    "a color fundus image diagnosed as {}.",
    "a retinal image with features of {}.",
    "a medical image of the retina classified as {}.",
    "a fundus photo showing signs of {}.",
    "a retinal scan labeled as {}.",
]
...
def evaluate_model(model_name, pretrained):
    print(f"\n🔍 Evaluating {model_name}-{pretrained} on Diabetic Retinopathy test set ...")
    try:
    ...
    dataset = DiabeticRetinopathyDataset(DATA_ROOT, TEST_TXT, transform=preprocess)
...
if __name__ == "__main__":
    ...
    out_csv = "diabetic_retinopathy_zero_shot_results.csv"
