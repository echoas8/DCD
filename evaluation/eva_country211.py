...
data_root = Path("./datasets/datasets/country211/country211")
batch_size = 64
num_workers = 8  # DataLoader 并行 worker 数量
...
def evaluate_model(model_name, pretrained, class_names, test_path):
    ...
    acc = correct / total
    print(f"✅ {model_name}-{pretrained} Accuracy: {acc:.4f}")
    return acc
