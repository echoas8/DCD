...
os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # 只让程序看到第2张卡

device = "cuda" if torch.cuda.is_available() else "cpu"
DATA_ROOT = "./datasets/datasets/renderedsst2/rendered-sst2"
TEST_SPLIT = "test"
...
# ===============================
TEMPLATES = [
    "an image of a sentence with {} sentiment.",
    "a rendered text expressing a {} feeling.",
    "a screenshot of a review that is {}.",
    "a piece of text conveying a {} emotion."
]
...
class FolderDataset(Dataset):
    def __init__(self, root, split, class_to_label, transform=None):
        self.root = root
        self.split = split
...
def evaluate_model(model_name, pretrained):
    print(f"\n🔍 Evaluating {model_name}-{pretrained} on Rendered-SST2 test set ...")
    ...
    dataset = FolderDataset(DATA_ROOT, TEST_SPLIT, class_to_label, transform=preprocess)
...
if __name__ == "__main__":
    ...
    out_csv = "renderedsst2_zero_shot_results.csv"
